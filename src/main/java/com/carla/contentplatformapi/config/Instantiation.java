...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post(null, format.parse("21/03/2018"), "Trip time!", "I'm traveling to São Paulo. See you!", maria);
        Post post2 = new Post(null, format.parse("23/03/2018"), "Good morning!", "Feeling happy this morning!", maria);
